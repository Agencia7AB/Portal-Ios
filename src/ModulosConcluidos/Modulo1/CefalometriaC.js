...
export default function CefalometriaC({ navigation }) {
    ...
    useEffect(() => {
           ...
           async function getGrupo () {
              ...
              async function Grupo2() {
                    ...
                    const q = query(citiesRef, where("formG2C1", "==", 'Cefalometría'), where("email", "==", email));
                    let array = [];
            ...
            async function Grupo3() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formG3C1", "==", 'Cefalometría'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo4() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formG4C1", "==", 'Cefalometría'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo5() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formG5C1", "==", 'Cefalometría'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo6() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("FormG6C1", "==", 'Cefalometría'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo7() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formG7C1", "==", 'Cefalometría'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo8() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formG8C1", "==", 'Cefalometría'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo9() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formG9C1", "==", 'Cefalometría'), where("email", "==", email));
                let array = [];
