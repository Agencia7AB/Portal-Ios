...
export default function Modulo2C({ navigation }) {
    ...
    useEffect(() => {
           ...
           async function getGrupo () {
              ...
              async function Grupo2() {
                    ...
                    const q = query(citiesRef, where("formÇ", "==", 'Módulo 2'), where("email", "==", email));
                    let array = [];
            ...
            async function Grupo3() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formT", "==", 'Módulo 2'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo4() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formX", "==", 'Módulo 2'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo5() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formK", "==", 'Módulo 2'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo6() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formP", "==", 'Módulo 2'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo7() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formW", "==", 'Módulo 2'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo8() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formG", "==", 'Módulo 2'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo9() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formAB", "==", 'Módulo 2'), where("email", "==", email));
                let array = [];
