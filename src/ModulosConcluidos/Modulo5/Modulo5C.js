...
export default function Modulo5C({ navigation }) {
    ...
    useEffect(() => {
           ...
           async function getGrupo () {
              ...
              async function Grupo2() {
                    ...
                    const q = query(citiesRef, where("formÇ", "==", 'Módulo 5'), where("email", "==", email));
                    let array = [];
            ...
            async function Grupo3() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formT", "==", 'Módulo 5'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo4() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formX", "==", 'Módulo 5'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo5() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formK", "==", 'Módulo 5'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo6() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formP", "==", 'Módulo 5'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo7() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formW", "==", 'Módulo 5'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo8() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formG", "==", 'Módulo 5'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo9() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formAB", "==", 'Módulo 5'), where("email", "==", email));
                let array = [];
