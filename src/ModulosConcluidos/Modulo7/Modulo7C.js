...
export default function Modulo7C({ navigation }) {
    ...
    useEffect(() => {
           ...
           async function getGrupo () {
              ...
              async function Grupo2() {
                    ...
                    const q = query(citiesRef, where("formÇ", "==", 'Módulo 7'), where("email", "==", email));
                    let array = [];
            ...
            async function Grupo3() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formT", "==", 'Módulo 7'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo4() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formX", "==", 'Módulo 7'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo5() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formK", "==", 'Módulo 7'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo6() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formP", "==", 'Módulo 7'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo7() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formW", "==", 'Módulo 7'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo8() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formG", "==", 'Módulo 7'), where("email", "==", email));
                let array = [];
            ...
            async function Grupo9() {
                ...
                const db = getFirestore();
                const citiesRef = collection(db, "Resumos");
                const q = query(citiesRef, where("formAB", "==", 'Módulo 7'), where("email", "==", email));
                let array = [];
